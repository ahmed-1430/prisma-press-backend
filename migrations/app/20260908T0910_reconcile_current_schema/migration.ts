...
export default class M extends Migration<Start, End> {
  ...
  override get operations() {
    return [
      ...
      // The preceding contract uses numeric IDs.  This database is explicitly
      // empty, so rebuild the affected tables instead of attempting an unsafe
      // numeric-to-UUID/text data conversion.
