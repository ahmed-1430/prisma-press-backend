...
export type StorageHash =
  StorageHashBase<'a40ed268abcc5dcf828ad3a7b53dda7bbdb8ca60508ed04ce9b280f161406dca'>;
export type ExecutionHash =
  ExecutionHashBase<'fd51472301040e8ec3fd116e261291ae2d17d1f362865efcab55aba577fbf29f'>;
      ...
      readonly public: {
        ...
        readonly enum: {
          ...
          readonly tags: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'TECHNOLOGY'; readonly value: 'TECHNOLOGY' },
              { readonly name: 'LIFESTYLE'; readonly value: 'LIFESTYLE' },
              { readonly name: 'TRAVEL'; readonly value: 'TRAVEL' },
              { readonly name: 'FOOD'; readonly value: 'FOOD' },
              { readonly name: 'FASHION'; readonly value: 'FASHION' },
              ...
              { readonly name: 'POLITICS'; readonly value: 'POLITICS' },
            ];
          };
        };
      };
