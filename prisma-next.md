...
Your data contract is the heart of your application. Model files live in the [`src/prisma/models/`](src/prisma/models/) directory and are combined into the generated `.generated/contract.prisma` before Prisma processes them:

```prisma
// src/prisma/models/users.prisma
model User {
...
[`prisma.config.ts`](prisma.config.ts) tells the CLI where your contract directory lives and how to connect to the database. It loads environment variables from `.env` automatically:
...
| File | Purpose |
|---|---|
| [`src/prisma/models/`](src/prisma/models/) | Your data contract — define models in the schema files here |
...
| `src/prisma/.generated/contract.json` | Compiled contract (generated) |
| `src/prisma/.generated/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit the appropriate schema file in [`src/prisma/models/`](src/prisma/models/) to add or change models.
